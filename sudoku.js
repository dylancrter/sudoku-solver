...
function sudoku_gui() {
    ...
    // create cells, assign row, col, and square
    for (var c = 0; c < 9; c++) {
        ...
        for (var r = 0; r < 9; r++) {
            ...
            cells.push(input); // puts cell into cells array
        }
...
function valid_check(cell, value) {
    // checks if value is valid, follows standard sudoku rules
...
function generate_sudoku() {
    // used in generation of sudoku board
